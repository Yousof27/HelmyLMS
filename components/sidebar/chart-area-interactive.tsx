  ...
  return (
    <Card className="@container/card">
      <CardHeader>
        ...
        <CardDescription>
          <span className="hidden @[540px]/card:block">Total Enrollments for the last 30 days: {totalEnrollments}</span>
      ...
      <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6">
        <ChartContainer config={chartConfig} className="aspect-auto h-[250px] w-full">
          <BarChart data={enrollments} margin={{ left: 12, right: 12 }}>
            ...
            />
            <Bar dataKey={"enrollments"} fill="var(--color-enrollments)" radius={2} />
          </BarChart>
        </ChartContainer>
      </CardContent>
    </Card>
